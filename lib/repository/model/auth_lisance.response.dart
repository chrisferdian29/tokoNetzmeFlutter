...
AuthLisanceResponse authLisanceResponseFromJson(String str) => AuthLisanceResponse.fromJson(json.decode(str));

String authLisanceResponseToJson(AuthLisanceResponse data) => json.encode(data.toJson());
