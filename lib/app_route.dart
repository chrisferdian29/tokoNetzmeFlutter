...
import 'Helpers/ReuseWidgets.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      // Validation of correct data type
        ...
        return _errorRoute();
      case '/payment.facepay.getStarted':
        if (args is int) {
          return MaterialPageRoute(
            builder: (_) => PaymentFacePayStartedWidget(args),
          );
        }
        return _errorRoute();
      ...
      // case '/alertRetry':
      //   return MaterialPageRoute(
      //     builder: (_) => ReuseWidgets.showLoaderDialog(context),
      //   );
