...
///
/// Note that the default result image size is 300x300. This value can be set in the interval [300, 1000], the larger the value, the more memory the SDK will consume.
